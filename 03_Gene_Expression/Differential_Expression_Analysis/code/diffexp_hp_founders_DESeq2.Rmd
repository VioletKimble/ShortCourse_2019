...
countData <- read.table("/Users/violetkimble/B/ShortCourse_2019/03_Gene_Expression/Differential_Expression_Analysis/data/hp_founder_gex_counts.txt", header = TRUE, check.names = FALSE)
row.names(countData) <- countData$locus
countData <- countData[,-1]
countData <- round(countData)
sampleSheet <- read.table("/Users/violetkimble/B/ShortCourse_2019/03_Gene_Expression/Differential_Expression_Analysis/data/SampleSheet_Chesler_Founders_Hippocampus_RNASeq.txt", header = TRUE)
